...
public class Activity2 extends Activity {
    final static String TAG = Activity2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        v1 = findViewById(R.id.textView2_1);
        v1.setText("ここに歩行距離を表示");
        v2 = new TextView(this);
        v2 = findViewById(R.id.textView2_2);
        v2.setText("ここに消費カロリーを表示");
        v3 = new TextView(this);
        v3 = findViewById(R.id.textView2_3);
        v3.setText("ここに目標を表示");
        v4 = new TextView(this);
        v4 = findViewById(R.id.textView2_4);
    ...
    public void getDataFromDB(){
        ...
        executor.execute(new Runnable(){
            ...
            public void run(){
                ...
                normaHour = Double.parseDouble(prefs.getString("setting_normaHour","0.0"));
                ...
                handler.post(new Runnable(){
                   ...
                   public void run(){
                       ...
                       String norma;
                       if(normaHour <= sumDistance){
                           norma = "目標達成！";
                       }else{
                           norma = "目標まであと" + (normaHour-sumDistance) + "km";
                       }

                       sumDistance = Math.round(sumDistance*100.0)/100.0;
                       sumKCal = Math.round(sumKCal*100.0)/100.0;

                       v1.setText("直近1時間の歩数:"+sumSteps+"\n直近1時間の歩行距離:"+sumDistance+"km\n"+station+" 相当");
                       v2.setText("直近1時間の消費カロリー"+sumKCal+"kcal\n"+food+" 相当");
                       v3.setText("1時間の歩行目標:"+normaHour+"km\n" + norma);
